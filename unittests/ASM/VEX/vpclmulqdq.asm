%ifdef CONFIG
{
  ...
  "RegData": {
      ...
      "XMM7":  ["0x1E2017C5BEE29400", "0x38358E40CC367C7A", "0x4B4B4B4B4B4B4B4B", "0x4B4B4B4B4B4B4B4B"],
      "XMM8":  ["0xE208147952DE57A0", "0x317D360F86C80DC9", "0x4646464646464646", "0x4646464646464646"],
      "XMM9":  ["0xBBA54C87DA872B40", "0x6495428B7641EBE6", "0x4444444444444444", "0x4444444444444444"],
      "XMM10": ["0x170B5A1B5CDD42EA", "0x719F094BB2358CA1", "0x4848484848484848", "0x4848484848484848"]
  }
}
%endif
...
vpclmulqdq ymm7, ymm1, ymm2, 0

; With imm = 0b00000001
vpclmulqdq xmm4, xmm1, xmm2, 1
vpclmulqdq ymm8, ymm1, ymm2, 1

; With imm = 0b00010000
vpclmulqdq xmm5, xmm1, xmm2, 16
vpclmulqdq ymm9, ymm1, ymm2, 16

; With imm = 0b00010001
vpclmulqdq xmm6, xmm1, xmm2, 17
vpclmulqdq ymm10, ymm1, ymm2, 17
