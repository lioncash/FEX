  ...
  if (!InterpreterOps::GetFallbackHandler(IROp, &Info)) {
    ...
    switch(Info.ABI) {
      ...
      case FABI_I32_I64_I64_I16_I128_I128: {
        ...
        umov<ARMEmitter::SubRegSize::i64Bit>(ARMEmitter::Reg::r3, Src1, 0);
        umov<ARMEmitter::SubRegSize::i64Bit>(ARMEmitter::Reg::r4, Src1, 1);

        umov<ARMEmitter::SubRegSize::i64Bit>(ARMEmitter::Reg::r5, Src2, 0);
        umov<ARMEmitter::SubRegSize::i64Bit>(ARMEmitter::Reg::r6, Src2, 1);

        ldr(ARMEmitter::XReg::x7, STATE_PTR(CpuStateFrame, Pointers.Common.FallbackHandlerPointers[Info.HandlerIndex]));
#ifdef VIXL_SIMULATOR
        GenerateIndirectRuntimeCall<uint32_t, uint64_t, uint64_t, uint16_t, uint64_t, uint64_t, uint64_t, uint64_t>(ARMEmitter::Reg::r7);
#else
