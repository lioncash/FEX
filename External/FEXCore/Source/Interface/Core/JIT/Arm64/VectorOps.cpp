...
DEF_OP(VUMin) {
  ...
  if (CanUseSVE) {
    ...
    switch (ElementSize) {
      case 1:
        umin(VTMP1.Z().VnB(), p0.Merging(), VTMP1.Z().VnB(), Vector2.Z().VnB());
        break;
      case 2:
        umin(VTMP1.Z().VnH(), p0.Merging(), VTMP1.Z().VnH(), Vector2.Z().VnH());
        break;
      case 4:
        umin(VTMP1.Z().VnS(), p0.Merging(), VTMP1.Z().VnS(), Vector2.Z().VnS());
        break;
      case 8:
        umin(VTMP1.Z().VnD(), p0.Merging(), VTMP1.Z().VnD(), Vector2.Z().VnD());
        break;
      default:
        LOGMAN_MSG_A_FMT("Unknown Element Size: {}", ElementSize);
        return;
...
DEF_OP(VSMin) {
  ...
  if (CanUseSVE) {
    ...
    switch (ElementSize) {
      case 1:
        smin(VTMP1.Z().VnB(), p0.Merging(), VTMP1.Z().VnB(), Vector2.Z().VnB());
        break;
      case 2:
        smin(VTMP1.Z().VnH(), p0.Merging(), VTMP1.Z().VnH(), Vector2.Z().VnH());
        break;
      case 4:
        smin(VTMP1.Z().VnS(), p0.Merging(), VTMP1.Z().VnS(), Vector2.Z().VnS());
        break;
      case 8:
        smin(VTMP1.Z().VnD(), p0.Merging(), VTMP1.Z().VnD(), Vector2.Z().VnD());
        break;
      default:
        LOGMAN_MSG_A_FMT("Unknown Element Size: {}", ElementSize);
        return;
...
DEF_OP(VUMax) {
  ...
  if (CanUseSVE) {
    ...
    switch (ElementSize) {
      case 1:
        umax(VTMP1.Z().VnB(), p0.Merging(), VTMP1.Z().VnB(), Vector2.Z().VnB());
        break;
      case 2:
        umax(VTMP1.Z().VnH(), p0.Merging(), VTMP1.Z().VnH(), Vector2.Z().VnH());
        break;
      case 4:
        umax(VTMP1.Z().VnS(), p0.Merging(), VTMP1.Z().VnS(), Vector2.Z().VnS());
        break;
      case 8:
        umax(VTMP1.Z().VnD(), p0.Merging(), VTMP1.Z().VnD(), Vector2.Z().VnD());
        break;
      default:
        LOGMAN_MSG_A_FMT("Unknown Element Size: {}", ElementSize);
        return;
...
DEF_OP(VSMax) {
  ...
  if (CanUseSVE) {
    ...
    switch (ElementSize) {
      case 1:
        smax(VTMP1.Z().VnB(), p0.Merging(), VTMP1.Z().VnB(), Vector2.Z().VnB());
        break;
      case 2:
        smax(VTMP1.Z().VnH(), p0.Merging(), VTMP1.Z().VnH(), Vector2.Z().VnH());
        break;
      case 4:
        smax(VTMP1.Z().VnS(), p0.Merging(), VTMP1.Z().VnS(), Vector2.Z().VnS());
        break;
      case 8:
        smax(VTMP1.Z().VnD(), p0.Merging(), VTMP1.Z().VnD(), Vector2.Z().VnD());
        break;
      default:
        LOGMAN_MSG_A_FMT("Unknown Element Size: {}", ElementSize);
        return;
