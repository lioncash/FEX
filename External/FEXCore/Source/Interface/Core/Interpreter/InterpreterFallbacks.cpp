...
template<>
FallbackInfo GetFallbackInfo(uint32_t(*fn)(uint64_t, uint64_t, uint16_t, __uint128_t, __uint128_t), FEXCore::Core::FallbackHandlerIndex HandlerIndex) {
  return {FABI_I32_I64_I64_I16_I128_I128, (void*)fn, HandlerIndex};
}
