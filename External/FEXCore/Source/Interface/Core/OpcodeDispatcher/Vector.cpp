...
OrderedNode* OpDispatchBuilder::PCMPESTRXOpImpl(OpcodeArgs,
  ...
  //      [OF | CF | SF | ZF]
  //
  const auto GetFlagBit = [this, OneConst, ZeroConst, IntermediateResult](int BitIndex) {
    return _Select(IR::COND_NEQ,
                   _And(IntermediateResult, _Constant(1 << BitIndex)), ZeroConst,
                   OneConst, ZeroConst);
  };
